          ...
          fine-grained policies.                                                    
            •  Coarse-grained network-tier policies — These perimeter control policies are informally
               called firewall rules and are mostly static as they specify:         
                 o                                                                  
                    The network location of the egress gateway from which the network edge element
                    at the exit point of a cloud network (e.g., outbound firewall, such as the one at the
                    edge of a cloud) can receive traffic                            
                 o                                                                  
                    The network location of the ingress gateway to which the incoming traffic that
            ...
            •  Fine-grained network-tier policies — This category of policies is also called
               ...
               premises location.                                                   
                 o                                                                  
                    Specify the path on which the outbound traffic from a service or an application
                 ...
                 o                                                                  
                    Specify the path for the inbound traffic into the on-premises network to reach the
                 ...
                 o                                                                  
                    Notably, they specify how traffic can flow “east-west” (i.e., inside of the
...
| TVheeri fSiPabIFleF IEd eIDnt iitsy cDarorcieudm ienn at (cSryVpItDog).r aSpPhIiFcFaElly s uvpepriofiratsb lme udloticpulme SenVt IcDa lfloerdm aa StsP, IbFuFt Eth e |
| --- |
| most commonly used is an X.509 certificate. |
...
NIST SP 800-207A                      ZTA Model for Access Control in Cloud-Native
          September 2023                         Applications in Multi-Location Environments
                                          ...
                                          21                                        
                 o                                                                  
                    To implement step-up authentication by asking for more information from users
