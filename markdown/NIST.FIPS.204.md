...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
             ...
             Algorithm 14 CoeffFromThreeBytes(𝑏                                     
                                      0                                             
                                       , 𝑏                                          
                                        1                                           
                                         , 𝑏                                        
             ...
             Algorithm 24 skEncode(𝜌, 𝐾, 𝑡𝑟, 𝐬                                      
                                   1                                                
                                    , 𝐬                                             
                                     2                                              
                                      , 𝐭                                           
             ...
             Algorithm 26 sigEncode(𝑐, 𝐳, 𝐡) ̃ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 35
...
39                                                               
                   ...
                   49                                                               
           FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
             Algorithm MakeHint(𝑧, 𝑟) . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 41
             Algorithm UseHint(ℎ, 𝑟) . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 41
             Algorithm NTT(𝑤) . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 43
             Algorithm NTT −1(𝑤) ̂ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 44
                              . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 44 Algorithm BitRev
                           8                                                        
                           (𝑚)                                                      
             Algorithm AddNTT(𝑎,̂ 𝑏)                                                
                               ̂                                                    
                                 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 45
             Algorithm MultiplyNTT(𝑎,̂ 𝑏)                                           
                                  ̂                                                 
                                   . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 45
             Algorithm AddVectorNTT(𝐯, ̂ 𝐰) ̂ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 45
             Algorithm ScalarVectorNTT(𝑐,̂ 𝐯) ̂ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 46
             Algorithm MatrixVectorNTT(𝐌,                                           
                                    ̂                                               
                                     𝐯) ̂ . . . . . . . . . . . . . . . . . . . . . . . . . . . . 46
             Algorithm MontgomeryReduce(𝑎) . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 50
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           2.1 Terms and Definitions                                                
             ...
             asymmetric                                                             
             cryptography                                                           
                           Cryptography that uses two separate keys to exchange data — one to encrypt
                           or digitally sign the data and one to decrypt the data or verify the digital
             ...
             certification authority The entity in a public-key infrastructure (PKI) that is responsible for issuing
                           certificates and exacting compliance with a PKI policy. (CA)
             ...
             eXtendable-Output                                                      
             Function (XOF)                                                         
                           A function on bit strings in which the output can be extended to any desired
                           length. Approved XOFs (e.g., those specified in FIPS 202 [7]) are designed
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           The following symbols and mathematical expressions are used in this standard.
             ...
             𝑞                         23 The prime number 𝑞 = 2 − 213 + 1 = 8380417.
             ...
             ℤ𝑛                                                                     
              𝑚                                                                     
                        The set of 𝑛-tuples over ℤ                                  
                                        𝑚                                           
                                         equipped with the ℤ-module structure.      
             𝑅                                     ℤ     𝑋256 The ring of single-variable polynomials over modulo + 1, also denoted by
                        ℤ[𝑋]/(𝑋256 + 1).                                            
             𝑅                                                                      
              𝑚                                                                     
                                                           256 The ring of single-variable polynomials over ℤ
                                                   𝑚                                
                                                     modulo 𝑋 + 1, also denoted by  
                        ℤ                                                           
                         𝑚                                                          
                          [𝑋]/(𝑋256 + 1).                                           
                                          5
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
             ...
             𝐵                                                                      
              𝜏                                                                     
                                            255  𝑖 The set of all polynomials 𝑝 = ∑ 𝑝
                                               𝑖                                    
                                                𝑋 in 𝑅                              
                                                    𝑞                               
                                                     that are such that exactly 𝜏 of the
                                            𝑖=0                                     
                        coefficients of 𝑝                                           
                                 𝑖                                                  
                                  are from the set {−1,1}, and all other coefficients are zero. (See
                        Section 7.3.)                                               
           ...
           precompute bitlen 𝑎 for these values and hard code the results, rather than computing them on the fly.
             BitRev                                                                 
                 8                                                                  
                 (𝑟)    Bit reversal of an 8-bit integer 𝑟. If 𝑟 = 𝑟                
                                                0                                   
                                                 +2𝑟                                
                                                   1                                
                                                                with      , +4𝑟     
             ...
             log                                                                    
               2                                                                    
                𝑥       The base 2 logarithm of 𝑥. For example, log                 
                                                  2                                 
                                                   (16) = 4.                        
             mod        If 𝛼 is a positive integer and 𝑚 ∈ ℤ or 𝑚 ∈ ℤ               
                                                   𝛼                                
                                                    , then 𝑚 mod 𝛼 denotes the unique
             ...
             ‖⋅‖                                                                    
              ∞                                                                     
                        The infinity norm. For an element 𝑤 ∈ ℤ, ‖𝑤‖ = |𝑤|, the absolute value of
                                                      ∞                             
                        𝑤. For an element 𝑤 ∈ ℤ                                     
                                                    ±                               
                                        𝑞                                           
                                         ,‖𝑤‖ = ∣𝑤 mod 𝑞∣ . For an element 𝑤 of 𝑅 or 𝑅
                                            ∞                                       
                                                                         𝑞          
                                                                          ,         
                        ‖𝑤‖ = max                                                   
                                0≤𝑖<256                                             
                                     ‖𝑤                                             
                                       𝑖                                            
                                       ‖ . For a length-𝑚 vector with entries from or ,
                          ∞                                                         
                                                        𝐰            𝑅  𝑅           
                                        ∞                                           
                                                                         𝑞          
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
             ...
             [[𝑎 < 𝑏]]  A Boolean predicate. A comparison operator inside double square brackets [[𝑎 < 𝑏]]
                        ...
                        be interpreted as elements of ℤ                             
                                           2                                        
                                            with 1 denoting true and 0 denoting false.
             ...
             𝑎 ∘ 𝑏      Multiplication of 𝑎 and 𝑏 in the ring 𝑇                     
                                               𝑞                                    
                                               .                                    
             𝑎 ⋅ 𝑏 or 𝑎𝑏 Multiplication in any of the rings ℤ, ℤ                    
                                               𝑚                                    
                                                , 𝑅, or 𝑅                           
                                                     𝑚                              
                                                      .                             
           ...
           2.4 Notation                                                             
           2.4.1 Rings                                                              
           Elements of the rings ℤ, ℤ                                               
                          𝑞                                                         
                           , ℤ                                                      
                             2                                                      
                              , 𝑅, and 𝑅                                            
                                    𝑞                                               
                                     are denoted by italicized lowercase letters (e.g., 𝑤). Elements
           of the ring 𝑇                                                            
                  𝑞                                                                 
                   are length-256 arrays of elements of ℤ                           
                                           𝑞                                        
                                            , and they are denoted by italicized letters with a
           hat symbol (e.g., 𝑤̂). The addition and multiplication of elements of 𝑇  
                                                     𝑞                              
                                                      are performed entry-wise. Thus,
           the 𝑖th entry of the product of two elements 𝑢̂ and 𝑣̂ of 𝑇              
                                             𝑞                                      
                                              is 𝑢[𝑖] ⋅ 𝑣[𝑖] ∈ ℤ                    
                                                       𝑞                            
                                                        . The multiplication operation ̂ ̂
           in 𝑇                                                                     
             𝑞                                                                      
              is denoted by the symbol ∘ (see Section 2.3).                         
           When a product 𝑎 ⋅ 𝑏 or a sum 𝑎 + 𝑏 is written and either 𝑎 or 𝑏 is a congruence class modulo 𝑚 (i.e., if
           either 𝑎 or 𝑏 is an element of ℤ                                         
                             𝑚                                                      
                               or 𝑅                                                 
                                  𝑚                                                 
                                   ), then the product or sum is also understood to be a congruence
           class modulo 𝑚 (i.e., an element of ℤ                                    
                                 𝑚                                                  
                                   or 𝑅                                             
                                      𝑚                                             
                                       ). Likewise, an element of 𝑅 or ℤ may be “typecast” to an
           element of 𝑅                                                             
                   𝑚                                                                
                     or ℤ                                                           
                       𝑚                                                            
                        , respectively, and may be used as the input of a function specified to act on an
           element of 𝑅                                                             
                   𝑚                                                                
                    or ℤ                                                            
                       𝑚                                                            
                        , respectively. In both cases, the element itself or its coefficients are mapped from
           ℤ to ℤ                                                                   
               𝑚                                                                    
                by taking the unique congruence class modulo 𝑚 that contains the integer.
           The coefficients of an element 𝑤 of 𝑅 or 𝑅                               
                                    𝑚                                               
                                      are denoted by 𝑤                              
                                                𝑖                                   
                                                 so that 𝑤 = 𝑤                      
                                                         0                          
                                                          +𝑤                        
                                                             ...
                                                             𝑋 +…+𝑤                 
                                                                    255             
                                                                      𝑋255 .        
           If 𝑤 is in 𝑅 (respectively, 𝑅                                            
                            𝑚                                                       
                             ) and 𝑡 is in ℤ (respectively, ℤ                       
                                               𝑑                                    
                                                ), then 𝑤(𝑡) denotes the polynomial 𝑤 =
           𝑤                                                                        
            0                                                                       
             + 𝑤                                                                    
               1                                                                    
                𝑋 + … + 𝑤                                                           
                       255                                                          
                         𝑋255 evaluated at 𝑋 = 𝑡.                                   
           2.4.2 Vectors and Matrices                                               
           Vectors with elements in 𝑅 or 𝑅                                          
                              𝑚                                                     
                               are denoted by bold lowercase letters (e.g., 𝐯). Matrices with elements
           in 𝑅 or 𝑅                                                                
                𝑚                                                                   
                  are denoted by bold uppercase letters (e.g., 𝐀).                  
                                          7
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           The Number Theoretic Transform (NTT) is a specific isomorphism between the rings 𝑅
                                                                 𝑞                  
                                                                  and 𝑇             
                                                                      𝑞             
                                                                       . Let        
           𝜁 = 1753 ∈ ℤ                                                             
                   𝑞                                                                
                    , which is a 512th root of unity. If 𝑤 ∈ 𝑅                      
                                            𝑞                                       
                                             , then                                 
                             NTT(𝑤) = (𝑤(𝜁                                          
                                      0                                             
           ...
           where 𝜁                                                                  
               𝑖                                                                    
                = 𝑤(𝜁2BitRev                                                        
                        8                                                           
                        (𝑖)+1) mod 𝑞. See Section 7.5 for an implementation discussion for NTT and NTT−1 .
           The motivation for using NTT is that multiplication is considerably faster in the ring 𝑇
                                                               𝑞                    
                                                                . Since NTT is an   
           ...
           If 𝐀 is a matrix with entries from 𝑅                                     
                                 𝑞                                                  
                                  , then NTT(𝐀) denotes the matrix computed via the entry-wise
           application of NTT to 𝐀. The symbol ∘ is also used to denote the matrix multiplication of matrices with
           entries in 𝑇                                                             
                  𝑞                                                                 
                  . Thus, NTT(𝐀𝐁) = NTT(𝐀) ∘ NTT(𝐁). Explicit algorithms for linear algebra over 𝑇
                                                                       𝑞            
                                                                        are         
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           problem and the short integer solution (SIS) problem. The LWE problem [15] is to recover a vector 𝐬 ∈ ℤ𝑛
                                                                         𝑞          
           given a set of random “noisy” linear equations2                          
           ...
           and 𝐞 is not given but known to be small.                                
                                       satisfied by 𝐬. The SIS problem is to find a non-zero solution
           𝐭 ∈ ℤ𝑛                                                                   
              𝑞                                                                     
               for a given linear system over ℤ                                     
                                   𝑞                                                
                                    of the form 𝐀𝐭 = 𝟎 such that ‖𝐭‖                
                                                         ∞                          
                                                           is small. For appropriate
           choices of parameters, these problems are intractable for the best known techniques, including Gaussian
           elimination.                                                             
           When the module ℤ𝑛                                                       
                       𝑞                                                            
                        in LWE and SIS is replaced by a module over a ring larger than ℤ
                                                                𝑞                   
                                                                 (e.g., 𝑅           
                                                                      𝑞             
                                                                      ), the        
           resulting problems are called Module Learning With Errors (MLWE) [4] and Module Short Integer Solution
           (MSIS). The security of ML-DSA is based on the MLWE problem over 𝑅       
                                                       𝑞                            
                                                        and a nonstandard variant of
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           The basic idea of ML-DSA and similar lattice signature schemes is to build a signature scheme from
                                                               , 𝐒                  
                                                                1                   
                                                                  ∈ ℤ𝐿×𝑛 an analogous interactive protocol, where a prover who knows matrices 𝐀 ∈ ℤ𝐾×𝐿
                                                            𝑞       𝑞               
                                                                       , and        
           𝐒                                                                        
            2                                                                       
             ∈ ℤ𝐾×𝑛                                                                 
               𝑞                                                                    
                  with small coefficients (for 𝐒                                    
                                   1                                                
                                    and 𝐒                                           
                                        2                                           
                                        ) demonstrates knowledge of these matrices to a verifier
           who knows 𝐀 and 𝐓 ∈ ℤ𝐾×𝑛                                                 
                          𝑞                                                         
                             = 𝐀𝐒                                                   
                                 1                                                  
                                  + 𝐒                                               
                                     2                                              
                                      . Such an interactive protocol would proceed as follows:
             1. Commitment: The prover generates 𝐲 ∈ ℤ𝐿                             
                                         𝑞                                          
                                           with small coefficients and commits to its value by
               sending 𝐰                                                            
                     Approx                                                         
                         = 𝐀𝐲 + 𝐲                                                   
                               2                                                    
                                to the verifier, where 𝐲                            
                                               2                                    
                                                ∈ ℤ𝐾                                
                                                  𝑞                                 
                                                    is a vector with small coefficients.
             2. Challenge: The verifier sends a vector 𝐜 ∈ ℤ𝑛                       
                                          𝑞                                         
                                           with small coefficients to the prover.   
             3. Response: The prover returns 𝐳 = 𝐲 + 𝐒                              
                                        1                                           
                                         𝐜, and the verifier checks that 𝐳 has small coefficients
               and that 𝐀𝐳 − 𝐓𝐜 ≈ 𝐰                                                 
                             Approx                                                 
                                 .                                                  
           As written, the above protocol has a security flaw: the response 𝐳 will be biased in a direction related
           to the private value 𝐒                                                   
                        1                                                           
                         . Likewise 𝐫 = 𝐰                                           
                                   Approx                                           
                                       − 𝐀𝐳 + 𝐓𝐜 = 𝐲                                
                                                  2                                 
                                                   + 𝐒                              
                                                     2                              
                                                      𝐜 is biased in a direction related
           to the private value 𝐒                                                   
                        2                                                           
                         . However, this flaw can be corrected when converting the interactive protocol
           ...
           Fiat-Shamir With Aborts signature, the public key is (𝐀, 𝐓), and the private key is (𝐒
                                                              1                     
                                                               , 𝐒                  
                                                                2                   
                                                                 ).                 
           ...
           security or efficiency reasons:                                          
             ...
             • For a still further reduction in public key size, the ML-DSA public key substitutes a compressed
               value 𝐭                                                              
                   1                                                                
                    for 𝐭, which drops the 𝑑 low-order bits of each coefficient.    
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
             ...
             • To reduce signature size, rather than including the commitment 𝐰     
                                                      Approx                        
                                                         = 𝐀𝐲+𝐲                     
                                                               2                    
                                                                in the signature,   
               the ML-DSA signature uses a rounded version of 𝐰 = 𝐀𝐲 as a commitment 𝐰
                                                              1                     
                                                               and includes only    
               the hash 𝑐 ̃of 𝐰                                                     
                        1                                                           
             ...
             • To ensure that 𝐰                                                     
                         1                                                          
                          can be reconstructed by the verifier from 𝐳 and the compressed value 𝐭
                                                                      1             
                                                                       , the        
               signature must also include a hint 𝐡 ∈ 𝑅                             
                                        2                                           
                                        𝑘 computed by the signer using the signer’s private key.
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
             ...
             2. The matrix 𝐀                                                        
                       ̂                                                            
                       generated in step 3 of ML-DSA.KeyGen_internal can be stored so that it need not
               be recomputed in later operations. Likewise, the matrix 𝐀            
                                                  ̂                                 
                                                   generated in step 5 of the verification
               algorithm ML-DSA.Verify_internal can also be stored. In either case, the matrix 𝐀
                                                                 ̂                  
                                                                  is data that is   
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           form:                                                                    
             ...
             3. For 𝑗 = 1 to 𝑘: (ctx, out                                           
                             𝑗                                                      
                              ) ← SHAKE256.Squeeze(ctx, 8𝑏                          
                                                 𝑗                                  
                                                  )                                 
             4. output ← out                                                        
                       1                                                            
           ...
           This equivalence holds whether or not |str                               
                                    𝑖                                               
                                     | and 𝑏                                        
                                         𝑗                                          
                                          are multiples of the SHAKE256 block length.
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           4.  Parameter   Sets                                                     
              ...
              (see Sections 6.1 and 6.2 of this document) ML-DSA-44 ML-DSA-65 ML-DSA-87
               ...
               𝜁 - a 512th root of unity in ℤ                                       
                                  𝑞                                                 
                                   [see §7.5] 1753      1753     1753               
               ...
               𝜏 - # of ±1’s in polynomial 𝑐 [see §6.2] 39 49     60                
                 𝜆 - collision strength of 𝑐 ̃[see §6.2] 128 192 256                
                                               217      219      219 𝛾              
                 1                                                                  
                  - coefficient range of 𝐲 [see §6.2]                               
               𝛾                                                                    
                2                                                                   
                 - low-order rounding range [see §6.2] (𝑞 − 1)/88 (𝑞 − 1)/32 (𝑞 − 1)/32
              ...
              Challenge entropy log                                                 
                            2                                                       
                             (                                                      
                              256                                                   
                               𝜏                                                    
                                ) + 𝜏 [see §6.2] 192    225      257                
           ...
           one can precompute and store 𝐀                                           
                               ̂                                                    
                               to speed up signing and verifying. Alternatively, if one wants to reduce
                                         15

| 8380417 1753 13 39 128 217 (𝑞 − 1)/88 (4,4) 2 78 80 | 8380417 1753 13 49 192 219 (𝑞 − 1)/32 (6,5) 4 196 55 |
| --- | --- |
| 192 4.25 | 225 5.1 |
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Output: Public key 𝑝𝑘 ∈ 𝔹32+32𝑘(bitlen (𝑞−1)−𝑑)                          
            ...
            2:                                                                      
            3:                                                                      
                                32+32+64+32⋅((ℓ+𝑘)⋅ and private key 𝑠𝑘 ∈ 𝔹 bitlen (2𝜂)+𝑑𝑘).
             𝜉 ← 𝔹32                                                                
             if 𝜉 = NULL then                                                       
            ...
            5:                                                                      
             ...
             return ML-DSA.KeyGen_internal (𝜉)                                      
           5.2 ML-DSA Signing                                                       
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Output: Signature 𝜎 ∈ 𝔹𝜆/4+ℓ⋅32⋅(1+bitlen (𝛾                             
                                       1                                            
                                       −1))+𝜔+𝑘.                                    
            1: if |𝑐𝑡𝑥| > 255 then                                                  
           ...
           signature 𝜎 ∈ 𝔹𝜆/4+ℓ⋅32⋅(1+bitlen (𝛾                                     
                                 1                                                  
                                 −1))+𝜔+𝑘,                                          
           context string 𝑐𝑡𝑥 (a byte string of 255 or fewer bytes).                
           Output: Boolean.                                                         
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           should also indicate the hash function or XOF used to compute the pre-hash. 5
           ...
           against both collision and second preimage attacks [7, Table 4]. 6       
           ...
           be at least 2𝜆 bits in length.                                           
                                                   The verification of a signature that is
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Output: ML-DSA signature 𝜎 ∈ 𝔹𝜆/4+ℓ⋅32⋅(1+bitlen (𝛾                      
                                            1                                       
                                             −1))+𝜔+𝑘 .                             
            1: if |𝑐𝑡𝑥| > 255 then                                                  
            2:  return ⊥          ▷ return an error indication if the context string is too long
            3: end if                                                               
            4:                                                                      
                              ▷                                  𝑟𝑛𝑑 ← {0}32 5: 𝑟𝑛𝑑 ← 𝔹32 for the optional deterministic variant, substitute
            6: if 𝑟𝑛𝑑 = NULL then                                                   
            7:  return ⊥          ▷ return an error indication if random bit generation failed
            8: end if                                                               
            9:                                                                      
           ...
           22: end switch                                                           
               ′ 23: 𝑀 ← BytesToBits(IntegerToBytes(1, 1) ∥ IntegerToBytes(|𝑐𝑡𝑥|, 1) ∥ 𝑐𝑡𝑥 ∥ OID ∥ PH
                 ...
                 ML-DSA Sign internal ′ 24: 𝜎 ← . _ (𝑠𝑘, 𝑀 , 𝑟𝑛𝑑)                   
           25: return 𝜎                                                             
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           unrelated key if the seed is mistakenly expanded using a parameter set other than the one originally intended.
                                      ̂                                             
                         In particular:                                             
             • A 32-byte public random seed 𝜌. Using this seed, a polynomial matrix 𝐀 ∈ 𝑅
                                                            𝑞                       
                                                            𝑘×ℓ is pseudorandomly   
               sampled9                                                             
           9More precisely, since only the NTT form of 𝐀, 𝐀 ∈ 𝑇                     
                                         𝑞                                          
                                          𝑘×ℓ = NTT(𝐀) is needed in subsequent calculations, the
           code actually computes 𝐀 ̂ as a pseudorandom sample over 𝑇               
                                              𝑞                                     
                                              𝑘×ℓ , and the sampling of 𝐀 = NTT−1(𝐀) ̂ is only
           implicit (i.e., it could be computed but is not).                        
                     from 𝑅                                                         
                         𝑞                                                          
                         𝑘×ℓ .                                                      
             • A 64-byte private random seed 𝜌′ . Using this seed, the polynomial vectors 𝐬
                                                             1                      
                                                              ∈ 𝑅                   
                                                                 𝑞                  
                                                                 ℓ and 𝐬            
           ...
           producing the polynomial vector 𝐭                                        
                                1                                                   
                                . This compression is an optimization for performance, not security.
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           vectors 𝐬                                                                
                1                                                                   
                 and 𝐬                                                              
                     2                                                              
                     , and a polynomial vector 𝐭                                    
                                      0                                             
                                       encoding the 𝑑 least significant bits of each coefficient of
           ...
           1                                                                        
            and 𝐬                                                                   
                2                                                                   
                 , and the polynomial vector 𝐭                                      
                                   0                                                
                                    encoding the 𝑑 least significant bits of each coefficient of the
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           signer first produces a “commitment” 𝐰                                   
                                   1                                                
                                    and then pseudorandomly derives a “challenge” 𝑐 from 𝐰
                                                                      1             
                                                                       and          
           ...
           In more detail, the main computations involved in the rejection sampling loop are as follows:
             • Using the ExpandMask function (Algorithm 34), the seed 𝜌″ , and a counter 𝜅, a polynomial vector
               𝐲 ∈ 𝑅                                                                
                   𝑞                                                                
                   ℓ is pseudorandomly sampled from the subset of polynomial vectors whose coefficients are
               moderately short (i.e., in the range [−𝛾                             
                                       1                                            
                                        + 1, 𝛾                                      
                                           1                                        
                                            ]).                                     
             • From 𝐲, the signer computes the commitment 𝐰                         
                                            1                                       
                                             by computing 𝐰 = 𝐀𝐲 and then rounding to a
               nearby multiple of 2𝛾                                                
                            2                                                       
                             using HighBits (Algorithm 37).                         
             • 𝐰                                                                    
                1                                                                   
                 and 𝜇 are concatenated and hashed to produce the commitment hash 𝑐.̃ This uses the function
           ...
           11The length of 𝑐 ̃is determined by the desired security with respect to the “message-bound signatures” property
            described in [14]. Here, a length of 𝜆/4 bytes or equivalently 2𝜆 bits is required for 𝜆 bits of classical security.
             • The signer computes the response 𝐳 = 𝐲 + 𝑐𝐬                          
                                           1                                        
                                            and performs various validity checks. If any of the
             ...
             • If the checks pass, the signer can compute a hint polynomial 𝐡, which will allow the verifier to
               reconstruct 𝐰                                                        
                       1                                                            
                        using the compressed public key along with the other components of the signature.
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Output: Signature 𝜎 ∈ 𝔹𝜆/4+ℓ⋅32⋅(1+bitlen (𝛾                             
            ...
            4: 𝐭                                                                    
              ...
              ̂                                                                     
               ...
               ̂                                                         ̂          
            5: 𝐀 ← ExpandA(𝜌)       ▷ 𝐀 is generated and stored in NTT representation as 𝐀
           ...
           11:  𝐲 ∈ 𝑅                                                               
                    𝑞                                                               
                    ℓ ← ExpandMask(𝜌″, 𝜅)                                           
           12:  𝐰 ← NTT −1(𝐀 ∘ ̂ NTT(𝐲))                                            
           13:  𝐰                                                                   
                 1                                                                  
                   ← HighBits(𝐰)                          ▷ signer’s commitment     
           14:          ▷ HighBits is applied componentwise (see explanatory text in Section 7.4)
           15:   ̃                                          ▷ commitment hash 𝑐 ← H(𝜇||w1Encode(𝐰
                                1                                                   
                                ), 𝜆/4)                                             
           16:  𝑐 ∈ 𝑅                                                               
                    𝑞                                                               
                     ← SampleInBall(𝑐)̃                    ▷ verifier’s challenge   
           17:   ̂ 𝑐 ← NTT(𝑐)                                                       
           18:  ⟨⟨𝑐𝐬                                                                
                   1                                                                
                   ⟩⟩ ← NTT −1(𝑐 ∘ ̂ 𝐬                                              
                        ...
                        0                                                           
                         ⟩⟩||                                                       
                           ∞                                                        
                             ≥ 𝛾                                                    
                               2                                                    
                                or the number of 1’s in 𝐡 is greater than 𝜔, then (z, h) ← ⊥
           29:    end if                                                            
           30:  end if                                                              
           31:  𝜅 ← 𝜅 + ℓ                                   ▷ increment counter     
           32: end while                                                            
           33: 𝜎 ← sigEncode(𝑐, 𝐳 ̃ mod                                             
                              ±                                                     
                               𝑞, 𝐡)                                                
           34: return 𝜎                                                             
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           The verifier first extracts the public random seed 𝜌 and the compressed polynomial vector 𝐭
                                                                   1                
                                                                    from the        
           ...
           then attempts to reconstruct the signer’s commitment (i.e., the polynomial vector 𝐰
                                                               1                    
                                                               ) from the public    
           key 𝑝𝑘 and the signature 𝜎. In ML-DSA.Sign_internal, 𝐰                   
                                               1                                    
                                                 is computed by rounding 𝐰 = 𝐀𝐲. In 
           ML-DSA.Verify_internal, the reconstructed value of 𝐰                     
                                            1                                       
                                             is called 𝐰′                           
                                                   1                                
                                                    since it may have been computed in
           a different way if the signature is invalid. This 𝐰′                     
                                        1                                           
                                         is computed through the following process: 
             ...
             • Use the signer’s response 𝐳 to compute                               
               ...
               because 𝑐 and 𝐬                                                      
                        2                                                           
                          have small coefficients, and 𝐭                            
                                           1                                        
                                            ⋅ 2𝑑 ≈ 𝐭 .                              
             • Use the signer’s hint 𝐡 to obtain 𝐰′                                 
                                    1                                               
                                     from 𝐰′                                        
                                          Approx                                    
                                             .                                      
           ...
           reconstructed 𝐰′                                                         
                     1                                                              
                      is consistent with the signer’s commitment hash 𝑐.̃ More precisely, the verifier checks
           that all of the coefficients of 𝐳 are sufficiently small (i.e., in the range (−(𝛾
                                                       1                            
                                                        − 𝛽), 𝛾                     
                                                            1                       
                                                             − 𝛽)), 𝐡 contains no   
           ...
           with 𝐰′                                                                  
               1                                                                    
                (represented as a byte string). If all of these checks succeed, then ML-DSA.Verify_internal returns
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Input: Signature 𝜎 ∈ 𝔹𝜆/4+ℓ⋅32⋅(1+bitlen (𝛾                              
                                      1                                             
                                      −1))+𝜔+𝑘.                                     
           Output: Boolean                                                          
            1: (𝜌, 𝐭                                                                
            ...
            2: (𝑐, 𝐳, 𝐡) ← sigDecode(𝜎)                  𝑐,̃ response 𝐳, and hint 𝐡 ̃ ▷ signer’s commitment hash
            ...
            8: 𝑐 ∈ 𝑅                                                                
                  𝑞                                                                 
                   ← SampleInBall(𝑐)̃           ▷ compute verifier’s challenge from 𝑐 ̃
            9: 𝐰′  ← NTT −1(𝐀 ∘ ̂ NTT(𝐳) − NTT(𝑐) ∘ NTT(𝐭                           
                                                1                                   
                                                 ⋅ 2𝑑)) ▷ 𝐰′   = 𝐀𝐳 − 𝑐𝐭            
                                                                      1             
                                                                       ⋅ 2𝑑         
           ...
           10: 𝐰                                                                    
               1                                                                    
               ′ ← UseHint(𝐡,𝐰′ )             ▷ reconstruction of signer’s commitment
                           Approx                                                   
           11:           ▷ UseHint is applied componentwise (see explanatory text in Section 7.4)
           12: 𝑐′̃ ← H(𝜇||w1Encode(𝐰′                                               
                              1                                                     
                              ), 𝜆/4)                 ▷ hash it; this should match 𝑐 ̃
           13: return [[ ||𝐳||                                                      
                      ∞                                                             
                        < 𝛾                                                         
                           1                                                        
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           assumption that the coefficients of 𝑤 are in a restricted range. SimpleBitPack assumes that 𝑤
                                                                    𝑖               
                                                                     ∈ [0, 𝑏]       
           for some positive integer 𝑏 and packs 𝑤 into a byte string of length 32 ⋅ bitlen 𝑏. BitPack allows for the
           more general restriction 𝑤                                               
                           𝑖                                                        
                            ∈ [−𝑎, 𝑏]. The BitPack algorithm works by merely subtracting 𝑤 from the
           polynomial ∑ 255 .                                                       
                   𝑖=0                                                              
                      𝑏𝑋𝑖                                                           
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           When 𝑏 + 1 is a power of 2, the coefficients are in [0, 𝑏].              
            ...
            4:  𝑤                                                                   
                 𝑖                                                                  
                  ← BitsToInteger((𝑧[𝑖𝑐], 𝑧[𝑖𝑐 + 1], … 𝑧[𝑖𝑐 + 𝑐 − 1]), 𝑐)           
            5: end for                                                              
            6: return 𝑤                                                             
           ...
           When 𝑎 + 𝑏 + 1 is a power of 2, the coefficients are in [−𝑎, 𝑏].         
            ...
            4:  𝑤                                                                   
                 𝑖                                                                  
                  ← 𝑏 − BitsToInteger((𝑧[𝑖𝑐], 𝑧[𝑖𝑐 + 1], … 𝑧[𝑖𝑐 + 𝑐 − 1]), 𝑐)       
            5: end for                                                              
            6: return 𝑤                                                             
           ...
           which is a vector of polynomials 𝐡 ∈ 𝑅                                   
                                  2                                                 
                                  𝑘 such that the total number of coefficients in 𝐡[0], 𝐡[1], … , 𝐡[𝑘−1]
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Output: A polynomial vector 𝐡 ∈ 𝑅                                        
                                   2                                                
                                   𝑘 or ⊥.                                          
            1: 𝐡 ∈ 𝑅                                                                
                  2                                                                 
           ...
           12:    𝐡[𝑖]                                                              
                     𝑦[Index]                                                       
                         ←  1          ▷ 𝑦[Index] says which coefficient in 𝐡[𝑖] should be 1
           13:    Index ← Index + 1                                                 
           14:  end while                                                           
           15: end for                                                              
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Input:𝜌 ∈ 𝔹32, 𝐭                                                         
                      1                                                             
                       ∈ 𝑅𝑘 with coefficients in [0, 2bitlen (𝑞−1)−𝑑 − 1].          
           Output: Public key 𝑝𝑘 ∈ 𝔹32+32𝑘(bitlen (𝑞−1)−𝑑).                         
            1: 𝑝𝑘 ← 𝜌                                                               
            2: for 𝑖 from 0 to 𝑘 − 1 do                                             
            3:  𝑝𝑘 ← 𝑝𝑘 || SimpleBitPack (𝐭                                         
                                   1                                                
                                    [𝑖], 2bitlen (𝑞−1)−𝑑 − 1)                       
            4: end for                                                              
            5: return 𝑝𝑘                                                            
           ...
           Output: 𝜌 ∈ 𝔹32, 𝐭                                                       
            ...
            3:  𝐭                                                                   
                 ...
                 [𝑖] ← SimpleBitUnpack(𝑧                                            
                                  𝑖                                                 
                                   , 2bitlen (𝑞−1)−𝑑 − 1) ▷ This is always in the correct range
            4: end for                                                              
            5: return (𝜌, 𝐭                                                         
                     1                                                              
                      )                                                             
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Input: 𝜌 ∈ 𝔹32, 𝐾 ∈ 𝔹32, 𝑡𝑟 ∈ 𝔹64 , 𝐬                                    
                                       1                                            
                                        ∈ 𝑅ℓ with coefficients in [−𝜂, 𝜂], 𝐬        
                                                                 2                  
                                                                  ∈ 𝑅𝑘 with         
           coefficients in [−𝜂, 𝜂], 𝐭                                               
                          0                                                         
                            ∈ 𝑅𝑘 with coefficients in [−2𝑑−1 + 1, 2𝑑−1].            
           ...
           1                                                                        
            ...
            3:  𝐬                                                                   
                 ...
                 [𝑖] ← BitUnpack(𝑦                                                  
                              𝑖                                                     
                               , 𝜂, 𝜂)  ▷ this may lie outside [−𝜂, 𝜂] if input is malformed
            4: end for                                                              
            5: for 𝑖 from 0 to 𝑘 − 1 do                                             
            6:  𝐬                                                                   
                 2                                                                  
            ...
            9:  𝐭                                                                   
                 ...
                 [𝑖] ← BitUnpack(𝑤                                                  
                              𝑖                                                     
                               , 2𝑑−1 − 1, 2𝑑−1)  ▷ this is always in the correct range
           10: end for                                                              
           11: return (𝜌, 𝐾, 𝑡𝑟, 𝐬                                                  
                          1                                                         
                          , 𝐬                                                       
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Algorithm 26 sigEncode( ̃ 𝑐, 𝐳, 𝐡)                                       
           Encodes a signature into a byte string.                                  
           Input: ̃                                                                 
                                                      2                             
                                                       . 𝑐 ∈ 𝔹𝜆/4, 𝐳 ∈ 𝑅ℓ with coefficients in [−𝛾
                                           1                                        
                                            + 1, 𝛾                                  
                                                1                                   
                                                 ], 𝐡 ∈ 𝑅𝑘                          
           ...
           Output: ̃                                                                
                                                        2                           
                                                        , or ⊥. 𝑐 ∈ 𝔹𝜆/4, 𝐳 ∈ 𝑅ℓ with coefficients in [−𝛾
                                            1                                       
                                             + 1, 𝛾                                 
                                                 1                                  
                                                  ], 𝐡 ∈ 𝑅𝑘                         
                             ...
                             𝑖                                                      
                              , 𝛾                                                   
                                1                                                   
                                 − 1, 𝛾                                             
                                     1                                              
                                      ) ▷ this is in the correct range, as 𝛾        
                                                               1                    
                                                                is a power of 2     
            4: end for                                                              
            5: 𝐡 ← HintBitUnpack(𝑦)                                                 
           ...
           vector 𝐰                                                                 
                1                                                                   
                 into a string of bytes so that it can be processed by the function H.
           Algorithm 28 w1Encode(𝐰                                                  
                             1                                                      
                             )                                                      
           Encodes a polynomial vector 𝐰                                            
                               1                                                    
                                 into a byte string.                                
           Input: 𝐰                                                                 
                 1                                                                  
                  ∈ 𝑅𝑘 whose polynomial coordinates have coefficients in [0, (𝑞 − 1)/(2𝛾
                                                                  2                 
                                                                   ) − 1].          
                                    𝐰                                               
                                     1                                              
                                      ∈ 𝔹32𝑘⋅bitlen ((𝑞−1)/(2𝛾                      
                                                    2                               
                                                     )−1) Output: A byte string representation ̃ .
            1: 𝐰̃                                                                   
               1                                                                    
                ← ()                                                                
            2: for 𝑖 from 0 to 𝑘 − 1 do                                             
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           defined is SampleInBall. As in Section 2.3, 𝐵                            
                                      𝜏                                             
                                       denotes the set of all polynomials 𝑐 ∈ 𝑅 such that
             • Each coefficient of 𝑐 is either −1, 0, or 1, and                     
             • Exactly 𝜏 of the coefficients of 𝑐 are nonzero.                      
                                                                                    
                                                                                    
           SampleInBall pseudorandomly generates an element of 𝐵                    
                                               𝜏                                    
                                                using the XOF of a seed 𝜌. The procedure
           ...
           choose the signs of the nonzero entries of 𝑐. Subsequent bytes are used to choose the positions of
           ...
           and ExpandMask. Each generates elements of 𝑅 or 𝑇                        
                                             𝑞                                      
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Output: An element ̂ 𝑎 ∈ 𝑇                                               
            ...
            6:   ̂ 𝑎[𝑗] ← CoeffFromThreeBytes(𝑠[0], 𝑠[1], 𝑠[2])                     
            7:  if 𝑎[𝑗] ≠ ⊥ then ̂                                                  
            8:    𝑗 ← 𝑗 + 1                                                         
            9:  end if                                                              
           10: end while                                                            
           ...
           Output: A polynomial 𝑎 ∈ 𝑅.                                              
            ...
            6:  𝑧                                                                   
                 0                                                                  
                  ← CoeffFromHalfByte(𝑧 mod 16)                                     
            7:  𝑧                                                                   
                 1                                                                  
                  ← CoeffFromHalfByte(⌊𝑧/16⌋)                                       
            8:  if 𝑧                                                                
                  0                                                                 
                   ≠ ⊥ then                                                         
            9:    𝑎                                                                 
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Input: A seed 𝜌 ∈ 𝔹32 .                                                  
            ...
            3:    𝜌′ ← 𝜌||IntegerToBytes(𝑠, 1)||IntegerToBytes(𝑟, 1)                
                    ̂ 4: 𝐀[𝑟, 𝑠] ← RejNTTPoly(𝜌′)     ▷ seed 𝜌′ depends on 𝑠 and 𝑟  
            5:  end for                                                             
            6: end for                                                              
            7: return 𝐀                                                             
                   ̂                                                                
           ...
           Samples vectors 𝐬                                                        
                      1                                                             
                        ∈ 𝑅ℓ and 𝐬                                                  
                               2                                                    
                                ∈ 𝑅𝑘 , each with polynomial coordinates whose coefficients are
           in the interval [−𝜂, 𝜂].                                                 
           Input: A seed 𝜌 ∈ 𝔹64 .                                                  
           Output: Vectors 𝐬                                                        
                       1                                                            
            ...
            2:  𝐬                                                                   
                 𝟏                                                                  
                  [𝑟] ← RejBoundedPoly(𝜌||IntegerToBytes(𝑟, 2)) ▷ seed depends on 𝑟 
            3: end for                                                              
            4: for 𝑟 from 0 to 𝑘 − 1 do                                             
            5:  𝐬                                                                   
                 𝟐                                                                  
                  [𝑟] ← RejBoundedPoly(𝜌||IntegerToBytes(𝑟 + ℓ,2)) ▷ seed depends on 𝑟 + ℓ
            6: end for                                                              
            7: return (𝐬                                                            
                    𝟏                                                               
                     , 𝐬                                                            
           ...
           Samples a vector 𝐲 ∈ 𝑅ℓ such that each polynomial 𝐲[𝑟] has coefficients between −𝛾
                                                                   1                
                                                                    + 1 and         
           𝛾                                                                        
            1                                                                       
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           and UseHint and explicitly defines these functions, where 𝑟 ∈ ℤ          
                                                   𝑞                                
                                                    , 𝑟                             
                                                     1                              
                                                      ,𝑟                            
                                                       0                            
                                                         ∈ ℤ, and ℎ is a Boolean (or
           equivalently an element of ℤ                                             
                             2                                                      
                             ). However, this specification also uses these functions where 𝐫, 𝐳 ∈ 𝑅
                                                                         𝑞          
                                                                         𝑘 ,        
           𝐫                                                                        
           1                                                                        
            , 𝐫                                                                     
             0                                                                      
               ∈ 𝑅𝑘 , and 𝐡 ∈ 𝑅                                                     
                         2                                                          
                         𝑘 . In this case, the functions are applied coefficientwise to the polynomials in the
           ...
           the hint allows the verifier to recover 𝐰                                
                                   1                                                
                                    ∈ 𝑅𝑘 , which represents 𝐰 ∈ 𝑅                   
                                                       𝑞                            
                                                       𝑘 rounded to a nearby multiple
           of 𝛼 = 2𝛾                                                                
                 2                                                                  
                 . The signer directly obtains 𝐰                                    
                                    1                                               
                                     using the function HighBits, and the part rounded off (i.e., 𝐫
                                                                         0          
                                                                         )          
           is obtained by LowBits. 𝐫                                                
                          0                                                         
                           is used by the signer in the rejection sampling procedure.
           Power2Round decomposes an input 𝑟 ∈ ℤ                                    
                                     𝑞                                              
                                      into integers that represent the high- and low-order bits of
           𝑟 mod 𝑞 in the straightforward bitwise way, 𝑟 mod 𝑞 = 𝑟                  
                                             1                                      
                                              ⋅ 2𝑑 + 𝑟                              
                                                  0                                 
                                                   , where 𝑟                        
           ...
           undesirable property that when 𝑟 is close to 𝑞 − 1 or 0, a small rounding error in 𝑟 can cause 𝑟
                                                                   1                
                                                                    to change       
           by more than 1, even accounting for wrap-around. In contrast to other unequal pairs of values of 𝑟
                                                                      1             
                                                                       ⋅ 2𝑑         
           and 𝑟                                                                    
              1                                                                     
              ′ ⋅ 2𝑑 , the distance (mod𝑞) between ⌊𝑞/2𝑑⌋ ⋅ 2𝑑 and 0 may be very small.
                                         39
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           To avoid this problem, this specification defines Decompose, which is similar to Power2Round except:
             ...
             • 𝑟 is generally decomposed as 𝑟 mod 𝑞 = 𝑟                             
                                        1                                           
                                         ⋅ 𝛼 + 𝑟                                    
                                              0                                     
                                              , where 𝛼 = 2𝛾                        
                                                        2                           
                                                         is a divisor of 𝑞 − 1.     
             • If the straightforward rounding procedure would return (𝑟            
                                                 1                                  
                                                  = (𝑞 − 1)/𝛼, 𝑟                    
                                                           0                        
                                                            ∈ [−(𝛼/2) + 1, 𝛼/2]),   
               Decompose instead returns (𝑟                                         
                                 1                                                  
                                  = 0,𝑟                                             
                                      0                                             
                                       − 1).                                        
           The functions HighBits and LowBits — which only return 𝑟                 
                                               1                                    
                                                and 𝑟                               
                                                   0                                
                                                    , respectively — and MakeHint and
           ...
           Returns 𝑟                                                                
                 1                                                                  
                  from the output of Decompose (𝑟).                                 
           Input: 𝑟 ∈ ℤ                                                             
                   𝑞                                                                
                    .                                                               
           Output: Integer 𝑟                                                        
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           There are other optimizations that are not included in this standard. In particular, mod 𝑞 and mod
                                                                      ±             
                                                                       𝑞 are        
           expensive operations whose use can be minimized by using Montgomery Multiplication (see Appendix A).
           An element of 𝑅                                                          
                     𝑞                                                              
                      is a polynomial in ℤ                                          
                                  𝑞                                                 
                                  [𝑋]/(𝑋256 + 1), and an element of 𝑇               
                                                         𝑞                          
                                                          is a tuple in Π255        
                                                                   𝑗=0              
                                                                     ℤ              
                                                                      𝑞             
                                                                       . The        
           NTT algorithm takes a polynomial 𝑤 ∈ 𝑅                                   
                                    𝑞                                               
                                     as input and returns ̂      ̂ 𝑤 ∈ 𝑇            
                                                      𝑞                             
                                                       . NTT −1 takes 𝑤 ∈ 𝑇         
                                                                    𝑞               
                                                                     as input       
           and returns 𝑤 such that 𝑤̂ = NTT(𝑤).                                     
           This document always distinguishes between elements of 𝑅                 
                                               𝑞                                    
                                                and elements of 𝑇                   
                                                           𝑞                        
                                                            . However, the natural  
           ...
           In Section 2.5, 𝜁 = 1753 ∈ ℤ                                             
                            𝑞                                                       
                             , which is a 512th root of unity modulo 𝑞. On input 𝑤 ∈ 𝑅
                                                                𝑞                   
                                                                 , the algorithm    
           outputs                                                                  
                            NTT(𝑤) = (𝑤(𝜁                                           
           ...
           NTT and NTT −1 use BitRev                                                
                            8                                                       
                             , which reverses the order of bits in an 8-bit integer.
                                         42
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           12:       𝑡 ← (𝑧 ⋅ 𝑤[𝑗 + 𝑙𝑒𝑛]) mod 𝑞 ̂                                   
           13:        ̂         ̂ 𝑤[𝑗 + 𝑙𝑒𝑛] ← (𝑤[𝑗] − 𝑡) mod 𝑞                     
           14:        ̂     ̂ 𝑤[𝑗] ← (𝑤[𝑗] + 𝑡) mod 𝑞                               
           15:    end for                                                           
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           The NTT converts elements of the ring 𝑅                                  
                                    𝑞                                               
                                     (where addition and multiplication are denoted by + and ⋅,
           respectively) into elements of the ring 𝑇                                
                                    𝑞                                               
                                     (where addition and multiplication are denoted by + and ∘,
           ...
           The ring 𝑇                                                               
                 𝑞                                                                  
                  is defined to be the direct product ring Π255                     
                                          𝑖=0                                       
                                            ℤ                                       
                                             𝑞                                      
                                              . Thus, an element ̂ 𝑎 ∈ 𝑇            
                                                             𝑞                      
                                                              is an array of length 
           256, and its elements are denoted by ̂ ̂ ̂ 𝑎[0], 𝑎[1], … , 𝑎[255] ∈ ℤ    
                                                 𝑞                                  
                                                 .                                  
           Algorithm 44 AddNTT(𝑎,̂ 𝑏)                                               
                             ̂                                                      
           Computes the sum ̂ 𝑏 of two elements 𝑎, 𝑏 ∈ 𝑇                            
                                            𝑞                                       
                                             . 𝑎 +                                  
                           ̂                                                        
                                       ̂                                            
           ...
           Output: ̂ 𝑐 ∈ 𝑇                                                          
            ...
            3: end for                                                              
            4: return 𝑐 ̂                                                           
           Algorithm 45 MultiplyNTT(𝑎,̂ 𝑏)                                          
                                ̂                                                   
                             ̂             ̂                                        
           Computes the product 𝑎 ∘ ̂ 𝑏 of two elements 𝑎,̂ 𝑏 ∈ 𝑇                   
                                              𝑞                                     
                                              .                                     
                  ̂                                                                 
           Input: 𝑎,̂ 𝑏 ∈ 𝑇                                                         
           ...
           Computes the sum ̂ ̂        ̂ ̂ 𝐯 + 𝐰 of two vectors 𝐯, 𝐰 over 𝑇         
                                              𝑞                                     
                                              .                                     
           Input: ℓ ∈ ℕ, ̂                                                          
                        𝑞                                                           
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           Algorithm 48 MatrixVectorNTT(𝐌,                                          
                                  ̂                                                 
                                   𝐯) ̂                                             
           Computes the product 𝐌 ∘                                                 
                           ̂                                                        
                             𝐯̂ of a matrix 𝐌                                       
                                       ̂                                            
                                        and a vector 𝐯̂ over 𝑇                      
                                                       𝑞                            
                                                       .                            
           Input: 𝑘,ℓ ∈ ℕ, 𝐌 ∈ 𝑇                                                    
                          𝑞                                                         
           ...
           Output: ̂                                                                
            ...
            4:      ̂           ̂           𝐌[𝑖, 𝑗], 𝐯[𝑗])) 𝐰[𝑖] ← AddNTT(𝐰[𝑖], MultiplyNTT(
                                             ̂                                      
                                                  ̂                                 
            5:  end for                                                             
            6: end for                                                              
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
          ...
          “reducing” the product by multiplying by 2−32 modulo 𝑞. This last operation can be done efficiently as
           ...
           Computes 𝑎 ⋅ 2−32 mod 𝑞.                                                 
                           31      31 Input: Integer 𝑎 with −2 𝑞 ≤ 𝑎 ≤ 2 𝑞.         
                      −32 Output: 𝑟 ≡ 𝑎 ⋅ 2 mod 𝑞.                                  
...
FIPS 204                       MODULE-LATTICE-BASED DIGITAL SIGNATURE STANDARD
           ...
           is extracted from the XOFs when executing these functions.14             
           ...
           14 RejBoundedPoly, RejNTTPoly, and SampleInBall use the incremental APIs described in Section 3.7 in order to
            extract the amount of output needed from the XOFs, given that the amount needed is not known in advance.
                                                If an implementation bounds the number of
           ...
           about the output distributions of XOFs and hash functions.               
               Table 3. While loop and XOF output limits for a 2−256 or less probability of failure
                    Algorithm    Minimum allowable limit                            
                                    (Loop iterations)                               
           ...
           are 4.25, 5.1, and 3.85 for Categories 2, 3, and 5, respectively. Therefore, the probability that the number
                                             ...
                                             𝑛                                      
                                                                   ...
                                                                   𝑛                
                                                                     ≤ 2−256 of repetitions exceeds 𝑛 is less than or equal to (5.1−1 for all categories. Solving (5.1−1
                                          5.1                   5.1                 
           yields 𝑛 = 814.                                                          
           RejBoundedPoly                                                           
           ...
           15Note that 0, 1, or 2 coefficients are generated in each iteration.     
                                                                          .         
                                        9   15 Then 𝑋 is 𝐵𝑖𝑛𝑜𝑚𝑖𝑎𝑙(2𝑛, 𝜃), where 𝜃 is either
                                        16                                          
                                          or                                        
                                            16                                      
                                             , depending on the parameter 𝜂. For 𝜃 =
                                                                        16          
                                                                        9 ,         
...
| Algorithm | Minimum allowable limit (Loop iterations) | Minimum allowable limit (XOF output bytes) |
| --- | --- | --- |
| ML-DSA.Sign_internal | 814 | N/A |
| RejBoundedPoly | 481 | 481 |
| RejNTTPoly | 298 | 894 |
...
⎧               1               if 𝑛 ≤ 8                     
           ...
           equal to ( 59                                                            
                 ...
                 256                                                                
                                 ...
                                 256                                                
                                   )𝑛 ≤ 2−256 yields a bound of 𝑛 = 121 for the while loop on step
