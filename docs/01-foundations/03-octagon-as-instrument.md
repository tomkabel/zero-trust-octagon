...
### Question 1 — No Intrinsic Trust → [§2: Axiom 1 — No Intrinsic Trust](./02-the-octagon.md#axiom-1-no-intrinsic-trust)
...
### Question 2 — Verifiable Policy → [§2: Axiom 2 — Explicit, Verifiable Policy](./02-the-octagon.md#axiom-2-explicit-verifiable-policy)
...
### Question 3 — Unbypassable Mediation → [§2: Axiom 3 — Unbypassable Mediation](./02-the-octagon.md#axiom-3-unbypassable-mediation)
...
### Question 4 — Continuous Verification → [§2: Axiom 4 — Continuous Verification](./02-the-octagon.md#axiom-4-continuous-verification)
...
### Question 5 — Deterministic Bounded Authority → [§2: Axiom 5 — Deterministic Bounded Authority](./02-the-octagon.md#axiom-5-deterministic-bounded-authority)
...
**Scoring:**
- 🟢 **Green:** No. Compromise of one component is contained. Defense responses are non-cascading (e.g., **Trickle-Truth**[↗](../appendix/appendix-c-glossary.md#trickle-truth) rather than Hard Deny). Independent observers detect divergences.
...
### Question 7 — Epistemic Integrity → [§2: Axiom 7 — Epistemic Integrity — Provenance of State](./02-the-octagon.md#axiom-7-epistemic-integrity-provenance-of-state)
...
### Question 8 — Bilateral Symmetry → [§2: Axiom 8 — Bilateral Symmetry — Mutual Verification](./02-the-octagon.md#axiom-8-bilateral-symmetry-mutual-verification)
...
The audit reveals a pattern that the data confirms [DR-§1]. The RSA 2026 ID IQ Report surveyed over 2,100 IAM and cybersecurity leaders. 69% of all respondents experienced an identity-related breach in the last three years [DR-§1], yet 57% self-assess their zero-trust maturity as "Advanced." The overlap is structural: organizations that believe they are "doing zero trust" are demonstrably breached through the identity pillar that zero trust exists to protect. The gap is not a measurement error. It is a structural feature of how architectures are evaluated.
...
The Violation Matrix is the gap's visible output. It shows not just where violations occur but *which* violations persist across archetypes. Two of the Octagon's eight validation principles — Axiom 7 (Epistemic Integrity, the requirement that state inputs carry cryptographic provenance) and Axiom 4 (Continuous Verification, the requirement that trust is re-verified at a cadence shorter than the compromise-to-exploitation window) — are violated by every non-Archetype-A deployment not because organizations lack tools but because their tools do not verify the inputs to their policy engines. The gap is between having controls and having verified controls.
