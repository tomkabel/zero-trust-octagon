...
- **Full audit guidance:** [Chapter 3: The Octagon as Validation Instrument](../03-octagon-as-instrument.md)
- **Leverage hierarchy:** [Chapter 7: Meta-Patterns](../07-meta-patterns.md)
- **Decision matrix:** [Chapter 18: Decision Matrix in Practice](../18-decision-matrix-and-conclusion.md)
