...
**Prerequisites:** [Chapter 9: Archetype B — Full Attack Trace](./09-archetype-b-fortune-500.md), [Chapter 12: Cross-Trace Synthesis](./12-cross-trace-synthesis.md), [Chapter 13: Self-Assessment](./13-self-assessment.md)
...
- **Builds on:** [Chapter 9: Archetype B — Full Attack Trace](./09-archetype-b-fortune-500.md)
